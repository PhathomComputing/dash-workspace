<body>
	...
	<?php if($_GET['grid']=='test'){require('inc/body/block/block-grid.php');}
else{?>

    <div id="block_grid" class="container">
        ...
        <div class="row">
            ...
            <!-- USER PROFILE BLOCK -->
			<?php require('inc/body/block/profile-block.php');?>

                <!-- LAST MONTH REVENUE -->         
            <?php require('inc/body/block/revenue-block.php');?>
          ...
          <?php include('inc/body/block/template.php');?>
