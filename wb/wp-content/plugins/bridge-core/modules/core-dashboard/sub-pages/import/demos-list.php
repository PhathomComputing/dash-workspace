...
if(!function_exists('bridge_core_demos_list')) {
	...
	function bridge_core_demos_list() {
		...
		$demos = array(
            ...
            'bridgedb431' => array(
                'title' => esc_html__('New Demo 431 - Transport Firm', 'bridge-core'),
                'rev-sliders' => array(
                    'slider-1.zip'
                ),
                'layer-sliders' => array(),
			...
			'bridgedb432' => array(
                'title' => esc_html__('New Demo 432 - Web Agency Showcase', 'bridge-core'),
                'rev-sliders' => array(),
                'layer-sliders' => array(),
                'required-plugins' => array('elementor', 'qi-addons-for-elementor', 'contact-form-7'),
                'categories' => array(
			...
			'bridgedb433' => array(
                'title' => esc_html__('New Demo 433 - Cloud Storage', 'bridge-core'),
                'rev-sliders' => array( 'slider-1.zip' ),
                'layer-sliders' => array(),
                'required-plugins' => array('elementor', 'qi-addons-for-elementor', 'contact-form-7', 'revslider'),
                'categories' => array(
			...
			'bridgedb434' => array(
                'title' => esc_html__('New Demo 434 - App Showcase Split', 'bridge-core'),
                'rev-sliders' => array(),
                'layer-sliders' => array(),
                'required-plugins' => array('elementor', 'qi-addons-for-elementor', 'contact-form-7'),
                'categories' => array(
			...
			'bridgedb435' => array(
                'title' => esc_html__('New Demo 435 - Alternating Portfolio', 'bridge-core'),
                'rev-sliders' => array(),
                'layer-sliders' => array(),
                'required-plugins' => array('elementor', 'qi-addons-for-elementor', 'contact-form-7'),
                'categories' => array(
